...
class CloudListCommandIT :
    FunSpec({
        ...
        context("success") {
            test("cloud list shows tenants and applications") {
                withTestContext {
                    runCommand(
                        commands =
                            listOf(
                        ...
                        val expectedOutput =
                            ...
                            Tenant: Other Tenant (other-tenant)
                            """.normalize()
        ...
        context("error") {
            test("cloud list failed login required") {
                withTestContext {
                    File(System.getProperty("user.home")).resolve(".noumena").deleteRecursively()
                    runCommand(
                        commands =
                        ...
                        val expectedOutput =
                            """
                            Command cloud list failed: Please login again.
                            """.normalize()
