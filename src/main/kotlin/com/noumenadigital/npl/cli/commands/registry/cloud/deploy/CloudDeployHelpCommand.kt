...
object CloudDeployHelpCommandDescriptor : CommandDescriptor {
    ...
    override fun createCommandExecutorInstance(parsedArguments: Map<String, Any>): HelpCommand = CloudDeployHelpCommand
}

data object CloudDeployHelpCommand : HelpCommand() {
    override fun execute(output: ColorWriter): ExitCode {
        printHelp(CloudDeployCommands.entries.map { it.commandDescriptor() }, output)
